...
* The problem with the instability of bert like models is very well known and is especially important for small datasets (like the one we were working with : less than 3000 training samples). Many papers tried to tackle this problem (please refer to these three papers : [REVISITING FEW-SAMPLE BERT FINE-TUNING
](https://arxiv.org/pdf/2006.05987.pdf) /  [How to Fine-Tune BERT for Text Classification?](https://arxiv.org/pdf/1905.05583.pdf) / [Optimizing Deeper Transformers on Small Datasets](https://arxiv.org/pdf/2012.15355.pdf)). 
...
* Large models i.e. Roberta large and Electra large
